...
export default function LandingPage() {
  return (
    <div className="min-h-screen text-slate-900 dark:text-white relative overflow-hidden transition-colors duration-200 bg-transparent">
      
      {/* Header / Navbar */}
      <header className="border-b border-slate-200 dark:border-white/5 bg-white/70 dark:bg-[#090B12]/70 backdrop-blur-md sticky top-0 z-50 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link href="#features" className="text-sm font-semibold text-slate-655 hover:text-slate-900 dark:text-slate-350 dark:hover:text-white transition-colors">
                Features
              </Link>
              <Link href="#about" className="text-sm font-semibold text-slate-655 hover:text-slate-900 dark:text-slate-350 dark:hover:text-white transition-colors">
                About Us
              </Link>
            </nav>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/auth"
              className="text-sm font-semibold text-slate-655 hover:text-slate-900 dark:text-slate-350 dark:hover:text-white transition-colors"
            >
              Sign In
            </Link>
            <Link
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 md:py-28 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-7 text-left space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight max-w-4xl text-slate-900 dark:text-white font-heading">
            Your AI{' '}
          ...
          <p className="text-slate-700 dark:text-slate-300 text-base md:text-lg max-w-xl leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-start items-center gap-4">
            ...
            <Link
              href="#features"
              className="w-full sm:w-auto px-8 py-4 border border-slate-300 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white font-bold rounded-xl text-sm hover:bg-slate-100/60 dark:hover:bg-white/5 transition-all text-center"
            >
              Explore Features
            </Link>
          </div>
      ...
      {/* Core Features Grid */}
      <section id="features" className="max-w-7xl mx-auto px-6 py-20 border-t border-slate-200 dark:border-white/5 relative z-10 space-y-12">
        <div className="text-center space-y-2">
          <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white font-heading">Everything You Need To Stand Out</h2>
          <p className="text-slate-650 dark:text-slate-400 text-sm max-w-md mx-auto">Maximize your interview callback rates using tailored workflows.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card glow-card glass-shine card-hover-rise p-6 rounded-2xl space-y-4">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white font-heading">Smart JD Match</h3>
          ...
          <div className="glass-card glow-card glass-shine card-hover-rise p-6 rounded-2xl space-y-4">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white font-heading">Resume Tailoring</h3>
          ...
          <div className="glass-card glow-card glass-shine card-hover-rise p-6 rounded-2xl space-y-4">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white font-heading">Applications Kanban</h3>
            <p className="text-slate-655 dark:text-slate-400 text-xs leading-relaxed">
      ...
      {/* About Us Section */}
      <section id="about" className="max-w-7xl mx-auto px-6 py-24 border-t border-slate-200 dark:border-white/5 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start text-left">
            ...
            <div className="glass-card glow-card glass-shine card-hover-rise p-8 rounded-[32px] relative overflow-hidden group">
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-1">
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight font-heading">Yoosuf Ali Saleel</h3>
                  <p className="text-xs font-semibold text-accent-primary uppercase tracking-widest">Full Stack Developer</p>
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold">AI Product Builder</p>
                </div>

                <div className="flex flex-wrap justify-center gap-2 pt-2">
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-white/5 border border-white/10 text-slate-700 dark:text-slate-350">
                    Next.js
                  </span>
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-white/5 border border-white/10 text-slate-700 dark:text-slate-350">
                    TypeScript
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white font-heading">About Us</h2>
            </div>

            <div className="space-y-6 text-slate-650 dark:text-slate-300 text-sm leading-relaxed">
              <p>
            ...
            <div className="glass-card glow-card glass-shine card-hover-rise p-6 rounded-2xl flex flex-col md:flex-row gap-6 items-center md:items-start">
              <div className="w-16 h-16 rounded-xl bg-white border border-slate-200 dark:border-white/10 flex items-center justify-center shrink-0 p-2 overflow-hidden shadow-sm">
                <img 
                  src="/yastudio.png" 
                  alt="YAStudio Logo" 
              ...
              <div className="space-y-2 text-center md:text-left">
                <h4 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider font-heading">YAStudio</h4>
                <p className="text-slate-650 dark:text-slate-400 text-xs leading-relaxed">
            ...
            <p className="text-slate-605 dark:text-slate-400 text-xs leading-relaxed italic border-l-2 border-accent-primary/40 pl-4 py-1">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 dark:border-white/5 py-10 bg-white/40 dark:bg-transparent text-slate-550 relative z-10 text-xs transition-colors duration-200">
